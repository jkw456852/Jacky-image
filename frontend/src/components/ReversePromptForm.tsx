...
const REVERSE_SETTINGS_KEY = 'jacky-reverse-prompt-settings';
...
export function ReversePromptForm({ wideMode = false, disabled = false, onConfigureApiKey }: ReversePromptFormProps) {
  ...
  const handleSubmit = () => {
    ...
    if (!configuredModel?.apiKeyConfigured || !configuredModel.baseUrl || !configuredModel.modelId) {
          ...
          <div className="flex min-h-40 flex-col items-center justify-center gap-4 px-4 py-8 text-center">
            ...
            <div className="max-w-md">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                请先在设置中配置 Jacky API 密钥，配置完成后即可使用反推提示词功能。
              </p>
            </div>
