...
import { buildSimpleProxyTextRequestBody, handleSimpleTextStreamEvent } from "@/lib/jacky-proxy-text";
    ...
    async (configNode: CanvasNodeData) => {
      ...
      try {
        ...
        optimizeHandleRef.current = streamPromptOptimize(
          { modelConfigId: textModel.id, model: textModel.id, mode, prompt: promptText, images, context },
          {
