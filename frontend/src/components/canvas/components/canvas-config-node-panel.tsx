...
export function CanvasConfigNodePanel({
  ...
  const handleParamsChange = (patch: Partial<GenerationParamsValue>) => {
    ...
    if (patch.webSearchEnabled !== undefined) next.webSearchEnabled = patch.webSearchEnabled;
    if (patch.imageSearchEnabled !== undefined) next.imageSearchEnabled = patch.imageSearchEnabled;
