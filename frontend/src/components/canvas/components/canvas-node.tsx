...
import { renderMarkdown } from "@/lib/render-reasoning";
...
function SimpleMarkdown({ content }: { content: string }) {
  ...
  // renderMarkdown 先 escape HTML，再做 Markdown 转换；不要在画布节点中
  // 手工拼接 HTML，否则 AI 输出的 <img>/<svg onerror> 会升级成 Electron XSS。
  return <div className="prose prose-sm max-w-none dark:prose-invert" dangerouslySetInnerHTML={{ __html: renderMarkdown(content) }} />;
}
